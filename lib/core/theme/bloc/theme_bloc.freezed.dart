...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( ThemeToggled value)?  toggled,TResult Function( ThemeChanged value)?  changed,required TResult orElse(),}){
final _that = this;
switch (_that) {
case ThemeToggled() when toggled != null:
return toggled(_that);case ThemeChanged() when changed != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( ThemeToggled value)  toggled,required TResult Function( ThemeChanged value)  changed,}){
final _that = this;
switch (_that) {
case ThemeToggled():
return toggled(_that);case ThemeChanged():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( ThemeToggled value)?  toggled,TResult? Function( ThemeChanged value)?  changed,}){
final _that = this;
switch (_that) {
case ThemeToggled() when toggled != null:
return toggled(_that);case ThemeChanged() when changed != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  toggled,TResult Function( ThemeMode themeMode)?  changed,required TResult orElse(),}) {final _that = this;
switch (_that) {
case ThemeToggled() when toggled != null:
return toggled();case ThemeChanged() when changed != null:
return changed(_that.themeMode);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  toggled,required TResult Function( ThemeMode themeMode)  changed,}) {final _that = this;
switch (_that) {
case ThemeToggled():
return toggled();case ThemeChanged():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  toggled,TResult? Function( ThemeMode themeMode)?  changed,}) {final _that = this;
switch (_that) {
case ThemeToggled() when toggled != null:
return toggled();case ThemeChanged() when changed != null:
return changed(_that.themeMode);case _:
